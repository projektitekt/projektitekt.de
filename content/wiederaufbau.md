...
Was mich persönlich an der medialen Aufmerksamkeit des Projektes freut: vielen Menschen außerhalb der stark betroffenen Orte ist überhaupt nicht bewusst, wie sich der Zustand veler Gebäude heute - fast ein Jahr danach - noch immer darstellt. Vielen ist ncht klar, dass immer noch getrocknet wird, Wohnungen unbewohnbar sind, Planer und Handwerker fehlen, Fluthilfegelder noch nicht geflossen sind usw. Bis in Stolberg (Altstadt, Mühle, Talachse,...) wieder überall ein normaler Alltag möglich ist, wird noch viel Zeit vergehen... 
